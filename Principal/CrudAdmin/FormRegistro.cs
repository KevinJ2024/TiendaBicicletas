...
namespace Principal
{
    public partial class FormRegistro : FormBase
    {
        ...
        private void ModificarFormularioPorEntidad()
        {
            switch (entidad)
            {
                case "Vendedor":
                    ...
                    lbResultado.Location = new Point(800, 650);
                ...
                case "Producto":
                    ...
                    lbTitle.Location = new Point(790,300);
                    tbNombre.PlaceholderText = "Nombre Producto";
                    tbNombre.Location = new Point(800, 400);

                    tbPrecio_producto = new TextBox();
                    tbPrecio_producto.Location = new Point(800, 450);
                    ...
                    tbStock = new TextBox();
                    tbStock.Location = new Point(800, 500);
                ...
                case "Factura":
                    ...
                    tbID.Location = new Point(800, 450);
                    tbID.PlaceholderText = "ID Cliente";

                    tbID_vendedor = new TextBox();
                    tbID_vendedor.Location = new Point(800, 500);
        ...
        private void btnCancelar_Click(object sender, EventArgs e)
        {
            ...
            else if (tbPrecio_producto != null || tbStock != null || tbDescripcion_producto != null || pbImagen != null) 
            {
